...
* **Off by default.** Every agent capability is opt-in behind three independent gates (`AgentCommandsEnabled`, per-command `Enabled`, `McpServerEnabled`), and the network door binds to localhost only.
