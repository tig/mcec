...
agents on Windows, and the same battle-tested remote control for home-automation systems it has always
been.
...
home-automation command surface (network and serial), which is unchanged.
...
* **[Environment Controller](environment-controller.html)** — the agent surface: the observation,
