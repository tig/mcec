...
agents on Windows, and the same battle-tested remote control for home-control systems it has always
been.
...
home-control command surface (network and serial), which is unchanged.
...
* **[Home Control](home_control.html)** — the classic role: listen on TCP/IP or a
