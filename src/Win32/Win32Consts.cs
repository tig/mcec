...
public class Win32Consts {
    ...
    public static readonly IntPtr HKEY_CLASSES_ROOT = new((long)unchecked((int)0x80000000));
    public static readonly IntPtr HKEY_CURRENT_USER = new((long)unchecked((int)0x80000001));
    public static readonly IntPtr HKEY_LOCAL_MACHINE = new((long)unchecked((int)0x80000002));
    public static readonly IntPtr HKEY_USERS = new((long)unchecked((int)0x80000003));
}
