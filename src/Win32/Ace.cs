...
public abstract class Ace {
    internal static Ace Create(MemoryMarshaler m) {
        ...
        Ace ace = head.AceType switch {
            AceType.ACCESS_ALLOWED_ACE_TYPE => new AceAccessAllowed(m),
            AceType.ACCESS_DENIED_ACE_TYPE => new AceAccessDenied(m),
            ...
            /*
                                            ...
                                            case AceType.ACCESS_DENIED_OBJECT_ACE_TYPE:
                                                ...
                                                break;
                            */
            _ => throw new NotSupportedException("Unsupported ACE type: " + head.AceType),
        };
