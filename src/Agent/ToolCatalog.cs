...
public static class ToolCatalog {
    ...
    private static JsonObject BuildDragSchema() {
        ...
        dragProps["from"] = EndpointSchema("Drag start: an element ({ by, value }) in the target window, or a pixel ({ x, y }). With a window target and a pixel endpoint, x/y are window-client-relative; without a window target they are absolute screen pixels.");
        dragProps["to"] = EndpointSchema("Drag end: an element ({ by, value }) in the target window, or a pixel ({ x, y }). With a window target and a pixel endpoint, x/y are window-client-relative; without a window target they are absolute screen pixels.");
    ...
    private static JsonObject BuildClickSchema() {
        ...
        clickProps["at"] = EndpointSchema("Where to click: an element ({ by, value }) in the target window (its centre) or a pixel ({ x, y }). With a window target and a pixel endpoint, x/y are window-client-relative; without a window target they are absolute screen pixels.");
