...
public class AgentServerTests {
    ...
    public void Dispatch_ToolsList_ClickTool_DeclaresAtEndpoint() {
        ...
        Assert.Contains("window-client-relative", props["at"]!["description"]!.GetValue<string>(), StringComparison.Ordinal);
    ...
    public void Dispatch_ToolsList_DragTool_DeclaresFromToEndpoints() {
        ...
        Assert.Contains("window-client-relative", props["from"]!["description"]!.GetValue<string>(), StringComparison.Ordinal);
        Assert.Contains("window-client-relative", props["to"]!["description"]!.GetValue<string>(), StringComparison.Ordinal);
